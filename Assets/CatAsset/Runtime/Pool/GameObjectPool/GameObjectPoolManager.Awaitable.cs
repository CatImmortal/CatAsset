...
namespace CatAsset.Runtime
{
    ...
    public static partial class GameObjectPoolManager
    {
        ...
        public static async
              ...
              CreatePoolAsync(string assetName, CancellationToken token = default)
        {
            ...
            handler.OnCanceled += ((localToken) => throw new OperationCanceledException(localToken));
            await handler;
            ...
            CancellationToken token = default)
        {
            ...
            bool success = await CreatePoolAsync(assetName,token);
            if (!success)
            {
                return null;
            }
...
#else
#endif
            PrewarmAsync(string assetName, int count, CancellationToken token = default)
        {
