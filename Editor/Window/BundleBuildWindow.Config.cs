    ...
    public partial class BundleBuildWindow
    {
        ...
        private void DrawBundleBuildConfigView()
        {
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                bundleBuildConfg.ManifestVersion = EditorGUILayout.IntField(bundleBuildConfg.ManifestVersion, GUILayout.Width(50));
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                for (int i = 0; i < targetPlatforms.Count; i++)
                {
                    ...
                    using (EditorGUILayout.ToggleGroupScope toggle = new EditorGUILayout.ToggleGroupScope(targetPlatform.ToString(), bundleBuildConfg.TargetPlatforms.Contains(targetPlatform)))
                    {
                        if (toggle.enabled)
                        {
            ...
            bundleBuildConfg.Options = (BuildAssetBundleOptions)EditorGUILayout.EnumFlagsField(bundleBuildConfg.Options);
